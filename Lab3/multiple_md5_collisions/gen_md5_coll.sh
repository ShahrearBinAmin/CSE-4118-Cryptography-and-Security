...
FASTCOLL='/home/shanto/PycharmProjects/Cryptography/Lab3/fastcoll_v1.0.0.5-1_source/fastcoll' # path to fastcoll

N=3 # Amount of colliding files generated would be 2^N
LAST_ID=`echo "2^$N" | bc`
